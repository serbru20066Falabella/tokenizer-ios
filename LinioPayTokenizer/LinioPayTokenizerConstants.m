...
NSUInteger const CHAR_LENGTH_COUNTRY_CODE = 3;
...
NSUInteger const ERROR_CODE_REQUIRED_COUNTRY_CODE = 190;
...
NSUInteger const ERROR_CODE_INVALID_COUNTRY_CODE = 490;
...
NSString * const ERROR_DESC_REQUIRED_COUNTRY_CODE = @"Address Country Code is Required";
...
NSString * const ERROR_DESC_INVALID_COUNTRY_CODE = @"Invalid Country Code - Should Contain 3 Characters Country Code";
